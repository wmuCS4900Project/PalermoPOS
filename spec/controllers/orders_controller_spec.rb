...
RSpec.describe OrdersController, :type => :controller do
  ...
  describe 'GET #custsearch' do
    ...
    before(:each) do
      @u1 = FactoryGirl.create :user, id: "1", username: "admin", password: "admin123", IsManager: true, Driver: false
      log_in(@u1)
  ...
  describe 'GET #startorder' do
    ...
    it "gets redirected to startorder if custid sent" do
      get :startorder, params: { custid: @c1.id }
      expect(response.location).to match('/orders/selectproduct')
    end
