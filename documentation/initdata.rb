...
Product.create :Name => "12 inch pizza", :Cost => 8.99, :category_id => 8
Product.create :Name => "16 inch pizza", :Cost => 11.99, :Category => :pizza, :Special => false, :DoesHalves => true, :DoesQuarters => true, :Generic => true
Product.create :Name => "12 inch deluxe pizza", :Cost => 13.99, :Category => :pizza, :Special => true, :DoesHalves => true, :DoesQuarters => true
Option.create :Name => "Ham", :Cost => 1, :category_id => 8
Option.create :Name => "Sausage", :Cost => 1, :category_id => 8
Option.create :Name => "Onion", :Cost => 1, :category_id => 8