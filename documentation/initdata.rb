...
Product.create :Name => "16 inch pizza", :Cost => 11.99, :category_id => 8
Product.create :Name => "Plain Sub", :Cost => 4.99, :category_id => 14
...
Option.create :Name => "Ham", :Cost => 0.5, :category_id => 14
Option.create :Name => "Lettuce", :Cost => 0.5, :category_id => 14
Option.create :Name => "Ham", :Cost => 0.5, :category_id => 14